                ...
                <div className="lg:col-span-2">
                    <form className="space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label className="block text-lg font-semibold text-[#1e2653] mb-2">First Name *</label>
                            ...
                            <div>
                                <label className="block text-lg font-semibold text-[#1e2653] mb-2">Last Name *</label>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label className="block text-lg font-semibold text-[#1e2653] mb-2">Email *</label>
                            ...
                            <div>
                                <label className="block text-lg font-semibold text-[#1e2653] mb-2">Organisation Name</label>
                        ...
                        <div>
                            <label className="block text-lg font-semibold text-[#1e2653] mb-2">Subject *</label>
                        ...
                        <div>
                            <label className="block text-lg font-semibold text-[#1e2653] mb-2">Your Message *</label>
                        ...
                        <button type="submit" className="bg-[#f39233] cursor-pointer hover:bg-orange-600 text-white font-semibold py-3 px-8 rounded-full transition duration-300">
                            Send Message
                        </button>
                    </form>
                </div>
