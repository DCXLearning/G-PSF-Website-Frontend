...
const SubmissionForm: React.FC = () => {
    ...
    const bannerData = useMemo(() => {
        ...
        const heroBlock =
            blocks.find((block) => block.id === 40 && block.type === "hero_banner") ||
            null;
    ...
    return (
        <section className="relative mt-1 min-h-[560px] overflow-hidden bg-gray-100">
            <div
            ...
            <div className="relative z-10 mx-auto flex min-h-[560px] w-full max-w-5xl flex-col items-center justify-center px-4 pt-20 pb-8 text-center">
                <h2
                    className={`mb-4 text-2xl font-bold leading-tight text-white sm:text-3xl md:text-5xl ${lang === "kh" ? "khmer-font" : ""
                        }`}
                >
